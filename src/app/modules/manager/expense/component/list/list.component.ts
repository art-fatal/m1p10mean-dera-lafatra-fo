...
export class ListComponent implements OnInit, OnDestroy, AfterViewInit{
  displayedColumns: string[] = ['date','name', 'amount']; // Exemple de colonnes
  ...
  private selectedItem: ExpenseModel;
  error: string;

  constructor(private toolbarAction: ToolbarActionService,private service: ExpenseService) {}
